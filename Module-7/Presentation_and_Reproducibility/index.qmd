...
- Use relative paths instead of absolute paths when importing data.
  ...
  - Absolute path example: "/Users/howarder/Documents/ST-437/data.csv"

  - Relative path example: "data.csv" where data.csv and the document importing the data are stored in the same directory
