...
- For quarto presentations, documents, dashboards, etc., host for free on [connect.posit.cloud](https://connect.posit.cloud/)

  - example: <https://019e1c70-ffe9-a397-7684-493f22f29ec1.share.connect.posit.cloud/>

  - A [beav.es](https://beav.es/) short link can be a nice way to share a long URL
...
- Use relative paths instead of absolute paths when importing data.
  ...
  - Relative path example: "/Users/howarder/Documents/ST-437/data.csv"

  - Absolute path example: "data.csv" where data.csv and the document importing the data are stored in the same directory
